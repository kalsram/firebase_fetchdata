...
class Editoccupation extends StatefulWidget {
  Editoccupation({super.key});

  @override
  State<Editoccupation> createState() => _EditoccupationState();
}

class _EditoccupationState extends State<Editoccupation> {
  @override
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: 'Add your new occupation',
                  hintStyle: TextStyle(
                      fontSize: 13,
